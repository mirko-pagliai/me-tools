...
* `Command::createDir()`, `Command::createFile()`, `Command::createLink()`, `TestCase::deleteLog()` and
  `TestCase::getLogFullPath()` methods are now deprecated and will be removed in a later release;
