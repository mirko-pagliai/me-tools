...
class AppValidatorTest extends TestCase
{
    ...
    public function testTitle(): void
    {
        ...
        $expected = ['title' => ['title' => 'Allowed chars: letters, numbers, apostrophe, space, slash, dash, parentheses. Has to begin with a capital letter']];
        ...
        foreach (['My title', 'My 4th title', 'Alfa/Beta', 'Alfa-Beta', 'Di Alessandro', 'D\'Alessandro', 'Casinò', 'First (second)'] as $title) {
