...
<div class="<?php echo $pluralVar; ?> index">
	<?php echo "<?php echo \$this->Html->h2(__('".ucfirst(strtolower($pluralHumanName))."')); ?>\n"; ?>
		...
		echo "\t<?php foreach(\${$pluralVar} as \${$singularVar}): ?>\n";
			echo "\t\t\t<tr>\n";
				echo "\t\t\t\t<td class=\"actions\">\n";
					...
					echo "\t\t\t\t\t<?php echo \$this->Form->postButton(NULL, array('action' => 'delete', \${$singularVar}['{$modelClass}']['{$primaryKey}']), array('class' => 'btn-danger', 'icon' => 'trash-o', 'tooltip' => __('Delete')), __('Are you sure you want to delete this?')); ?>\n";
				echo "\t\t\t\t</td>\n";
